...
const statuses = [
    { value: "Not Working On", icon: CircleX, color: "border-chart-1 text-chart-1" },
    { value: "Working On", icon: BriefcaseBusiness, color: "border-chart-2 text-chart-2" },
    { value: "Completed", icon: CheckCheck, color: "border-chart-3 text-chart-3" },
